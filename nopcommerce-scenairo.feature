Feature: Demo Nopcommerce's topmenu acceptance criteria
  As a user, I would like to check acceptance criteria of Nopcommeerce topmenu
...
Scenario: : Verify that user can navigate to Books category
  ...
  Scenario: : Verify that user can see 'Grid' tab on Book Category page
    ...
    Then  'Grid' tab is is available on Book Category page

  Scenario: : Verify that user can see 'List' tab on Book Category page
    Given User is on Books Category page
    When  User is on Books Category page
    And   Check 'List' tab is present
    Then  'List' tab is is available on Book Category page

  Scenario: : Verify that user can see 'Name: A to Z' selection is present in 'Sort by' filter
    Given User is on Books Category page
    When  User is on Books Category page
    And   Check 'Sort by' filter
    And   Check that user can see 'Name: A to Z' selection is present
  ...
  Scenario: : Verify that user can see 'Name: A to Z' selection is present in 'Sort by' filter
    ...
    When  User is on Books Category page
    And   Check 'Sort by' filter
    And   Check that user can see 'Name: A to Z' is first in order
    Then  'Name: A to Z' is first option in order

  Scenario: : Verify that user can see 'Name: A to Z' filter is functioning as expected(Note: Products are filtered in alpabetical order)
    Given User is on Books Category page
    When  User is on Books Category page
    And   Check 'Sort by' filter
